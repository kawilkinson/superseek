...
func (db *RedisDatabase) GetQueueSize(ctx context.Context) int64 {
...
func (db *RedisDatabase) SignalCrawler(ctx context.Context) {
	db.Client.LPush(ctx, indexerutil.SignalQueueKey, indexerutil.ResumeCrawl)
	log.Println("signaled crawler")
}

func (db *RedisDatabase) PushToImageIndexerQueue(ctx context.Context, normalizedURL string) {
